...
typename DiffeomorphicDemonsRegistrationWithMaskFilter<TFixedImage,
  TMovingImage, TDisplacementField>::DemonsRegistrationFunctionType *
DiffeomorphicDemonsRegistrationWithMaskFilter<TFixedImage, TMovingImage,
  TDisplacementField>
...
const
typename DiffeomorphicDemonsRegistrationWithMaskFilter<TFixedImage,
  TMovingImage, TDisplacementField>::MaskType *
DiffeomorphicDemonsRegistrationWithMaskFilter<TFixedImage, TMovingImage,
  TDisplacementField>
  ...
  ::ApplyUpdate(const TimeStepType& dt)
{
  ...
  if ( fabs(dt - 1.0) > 1.0e-4 )
    ...
    typename DisplacementFieldType::PixelType dtDis(dt);
    m_Multiplier->SetConstant( dtDis );
